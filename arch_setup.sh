diff --git a/arch_gaming_setup.sh b/arch_gaming_setup.sh
index 88b7098286f76b53a97ff9d0d213af2aa9038cef..e3d7047cfd13fdfe8d463f9b4f95311bb3bfe61b 100644
--- a/arch_gaming_setup.sh
+++ b/arch_gaming_setup.sh
@@ -4,632 +4,469 @@ set -Eeuo pipefail
############################################
...
curl --head --silent --show-error --fail --max-time 5 https://archlinux.org >/dev/null
}
...
gpu_lines=$(lspci -k | grep -Ei "VGA compatible controller|3D controller|Display controller" || true)
...
log_info "Optimizing mirrorlist with reflector"
...
log_ok "linux-zen already installed, skipping kernel reinstall"
